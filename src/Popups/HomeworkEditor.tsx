...
import { Page, Navbar, List, ListInput, Block, Button } from "framework7-react";
...
class HomeworkEditor extends React.Component<Props> {//todo Избавиться от глобальных IDшников на input'ах
    ...
    render() {
        ...
        return <Page noToolbar>
            ...
            <Navbar title={this.editingMode ? "Изменение ДЗ" : "Добавление ДЗ"} backLink="Назад" />
                <Formik
                    ...
                    <>
                        <List noHairlinesMd>{/* TODO: onChange вызывается слишком часто */}
                            ...
                            <ListInput
                                ...
                                info="Ограничение 19 МБ на каждый файл. Максимальное кол-во файлов: 10"
                                />
                                {/* TODO upper text */}
